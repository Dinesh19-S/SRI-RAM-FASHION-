...
const AuditorPurchasePage = () => {
    ...
    const handleSearch = async () => {
        setIsLoading(true);
        try {
            const response = await reportsAPI.getAuditorPurchase({
                fromDate,
                toDate
            });
    ...
    const handleEmail = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                toast.success('Auditor purchase report emailed successfully!');
            } else {
                            ...
                            {reportData.length > 0 ? (
                                ...
                                <tr>
                                    <td colSpan="9" className="py-8 text-center text-gray-500">
                                        {isLoading ? 'Loading...' : 'No data available. Click SEARCH to load auditor purchase data.'}
                                    </td>
                                </tr>
                            )}
                        </tbody>
...
export default AuditorPurchasePage;
