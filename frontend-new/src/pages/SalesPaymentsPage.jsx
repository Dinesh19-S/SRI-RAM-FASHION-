...
const SalesPaymentsPage = () => {
    ...
    const handleOpenModal = (payment = null) => {
        if (payment) {
            setFormData({
                ...
                customer: payment.customer?._id || null,
            ...
            setCustomerSearch(payment.companyName || '');
    ...
    const handleSave = async () => {
        if (!formData.companyName || !formData.amount) {
            toast.warning('Please fill Customer and Amount');
            return;
        }
        try {
            const payload = {
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        setFormData(prev => ({ ...prev, companyName: e.target.value, customer: null }));
