...
import { Search, ShoppingCart, X, Printer } from 'lucide-react';
...
const PurchaseReportsPage = () => {
    ...
    const handleExport = () => {
        ...
        exportToExcel(exportData, 'purchase_report');
    };
                ...
                <div className="flex flex-wrap items-end justify-between gap-3">
                    <div className="flex flex-wrap items-end gap-3">
                        <div className="flex-shrink-0">
                            ...
                            <input type="text" placeholder="Enter invoice number" value={supplierSearch} onChange={(e) => setSupplierSearch(e.target.value)} className="form-input w-36 text-sm py-1.5" />
                        </div>
                        <div className="flex-shrink-0">
                            <label className="block text-xs font-medium text-gray-600 mb-1">Supplier</label>
                            <input type="text" placeholder="Enter supplier name" value={supplierSearch} onChange={(e) => setSupplierSearch(e.target.value)} className="form-input w-40 text-sm py-1.5" />
                        </div>
                        <div className="flex-shrink-0">
                        ...
                        <button onClick={() => { setSupplierSearch(''); setFromDate(''); setToDate(''); }} className="px-3 py-1.5 text-gray-500 hover:text-gray-700 font-medium text-sm">Clear</button>
                    </div>
